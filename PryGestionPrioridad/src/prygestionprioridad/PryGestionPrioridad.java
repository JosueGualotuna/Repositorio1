        ...
        do {
            ...
            while (true) {
                if (entrada.hasNextInt()) {
                    ...
                    System.out.print("ingrese una valor numerico: ");
                    entrada.nextLine();
                }
            }
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    System.out.print("Ingrese el numero de prioridad de la tarea (1 a 5): ");
                    int prioridad;
                    while (true) {
                        if (entrada.hasNextInt()) {
                            while (true) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.print("ingrese el nombre de la tarea completada para eliminarla: ");
